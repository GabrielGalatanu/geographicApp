...
export default function QuizGame(props) {
  ...
  const getCountriesFromApiAsync = async () => {
    try {
      ...
      console.log("COUNTRIES ASYNC ESTE: ");
      console.log(json);
        ...
        >
          <View style={styles.contentContainer}>
            ...
            <View style={styles.answerOptionsContainer}>
              <QuizButton
                index={0}
                text={countries[shuffleVariants[0]].capital}
                //text="asd"
                ok={variants[0]}
              ...
              <QuizButton
                index={1}
                text={countries[shuffleVariants[1]].capital}
                ok={variants[1]}
                onPress={(index) => variantButtonPressed(index)}
              />
              <QuizButton
                index={2}
                text={countries[shuffleVariants[2]].capital}
                ok={variants[2]}
                onPress={(index) => variantButtonPressed(index)}
              />
              <QuizButton
                index={3}
                text={countries[shuffleVariants[3]].capital}
                ok={variants[3]}
                onPress={(index) => variantButtonPressed(index)}
              />
            </View>
